...
if __name__ == '__main__':
    ...
    _path = os.path.split(os.path.split(os.path.split(os.path.split(os.path.split(os.path.dirname(os.path.abspath(__file__)))[0])[0])[0])[0])[0] + '\\data\\kdb\\stocks\\csv\\stocks_' + today + '.csv'
    ...
    _db_file = 'stocks.db'
    sdt = SetDataToday()
    sdt.set_data(_path, _db_dir, _db_file)