...
import unittest
import SetData
import ShowStockData
sys.path.append(os.pardir + '\\ProcessData\\src')
from pandas import DataFrame


class TestShowStockData(unittest.TestCase):
    ...
    def test_show_code_data1(self):
        ...
        shd = ShowStockData.ShowStockData()
        df = DataFrame(columns=shd.data_index)
        df = df.append(shd.show_code_data(db_dir, '2014-01_01_' + db_file, "1301-T"))
        pass
